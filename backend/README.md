...
## Project Structure
    ...
    ├── tst_abcxyzdjsbvcbeh_66552  # Django project configurations
...
1. Clone this repo and `cd tst_abcxyzdjsbvcbeh_66552`
...
2. Clone this repo and `cd tst_abcxyzdjsbvcbeh_66552`
